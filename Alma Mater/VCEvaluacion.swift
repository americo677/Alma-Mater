...
class VCEvaluacion: UIViewController {
    ...
    func loadPreferences() {
        ...
        initToolBar(toolbarDesign: .toLeftBackToRightSaveStyle, actions: [nil, #selector(self.btnGuardarOnTouchUpInside(_:))], title: "Nueva Evaluación")
